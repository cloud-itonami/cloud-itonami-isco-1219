(ns business-admin.advisor
  "AdminManagementAdvisor — proposes a business-administration-management
  operation (coordinate a client task, review a compliance checklist,
  process payroll, submit a regulatory filing) for a registered client.
  ...
  store and has no notion of client provenance or payroll/regulatory risk;
  `business-admin.governor` is the independent system that decides whether
  the proposal may proceed, per the itonami actor pattern.

  A proposal is a map:
    {:op :coordinate|:review|:process-payroll|:submit-regulatory-filing
...
(def ^:private system-prompt
  "You are a business-administration-management advisor. Given an
   administration operation request, propose an :op, an honest :confidence
